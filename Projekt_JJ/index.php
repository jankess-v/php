...
<section class="d-flex justify-content-center align-content-center">
    <div class="container-weather px-5">
        <h4 class="mb-3">Pogoda</h4>
        <div class="input-weather">
            <input type="text" class="inputValue" placeholder="Wprowadź lokalizację">
            <button class="weather btn-dark"><i class="fas fa-search"></i></button>
        </div>
        <h1 class="temp">----°C</h1>
        <p class="desc">---</p>
        <div class="weather-icon"><img src="icons/02d.png" alt=""></div>
    </div>
</section>
