<?php
    ...
    if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
        ...
        if(isset($_GET["action"]) && $userData["status"] == 2) {
            $db->deleteUserById($_GET["action"]);
        }
	?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="container px-5">
			<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
				...
				<div class="row gx-5 justify-content-center mt-4">
                    ...
                    <div class="text-center m-5 justify-content-center">
                        <h3 class="fw-bolder">Dodaj użytkownika</h3>
                        <div class="d-flex justify-content-center">
                            <?php
                                $um->adminAddUserForm();
                            ?>
                        ...
                        <?php
                            if(filter_input(INPUT_POST, 'addUser', FILTER_SANITIZE_FULL_SPECIAL_CHARS) == "Dodaj") {
                                $um->adminAddUser($db);
                            }
                        }
                        ?>
