...
<head>
	...
	<title>Lingarium - Zaloguj się</title>
	<!-- Favicon-->
...
<main class="flex-shrink-0">
	...
	<nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
		<div class="container px-5">
			<a class="navbar-brand" href="#scroll-down">Zaloguj</a>
			...
			<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
				<div class="row gx-5 justify-content-center">
					<div class="col-lg-8 col-xl-6 justify-content-center">
						...
						<?php
							$um = new UserManager();
							if(filter_input(INPUT_GET, 'action') == "wyloguj"){
								$um->logout($db);
							}
								...
								if($userId > 0){
									...
									echo "
                                        <div class='alert alert-danger m-5 text-center'>
                                            <h4>Wprowadzono nieprawidłowe dane</h4>
                                        </div>";
									$um->loginForm();
								}
							} else {
