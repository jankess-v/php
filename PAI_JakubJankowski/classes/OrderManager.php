...
class OrderManager
{
	...
	public function displayOrdersById($db, $userId) {
		...
		if ($result !== "<div class='table-responsive'><table class='table table-bordered'><tbody><tr class='table-primary'><th>Nr zamówienia</th><th>Id użytkownika</th><th>Kursy</th><th>Imię i nazwisko</th><th>Email</th><th>Telefon</th><th>Adres</th><th>Dostawa</th><th>Suma</th><th>Data</th></tr></tbody></table></div>"){
			echo $result;
		} else {
	...
	public function displayAllOrders($db) {
		...
		$result = $db->selectOrderAdmin($sql);
		if ($result !== "<div class='table-responsive'><table class='table table-bordered'><tbody><tr class='table-primary'><th>Nr zamówienia</th><th>Id użytkownika</th><th>Kursy</th><th>Imię i nazwisko</th><th>Email</th><th>Telefon</th><th>Adres</th><th>Dostawa</th><th>Suma</th><th>Data</th><th>Usuń</th></tr></tbody></table></div>"){
			echo $result;
		} else {
			echo '<div class="alert alert-warning m-3">Brak zamówień do wyświetlenia.</div>';
		}
